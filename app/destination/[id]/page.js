        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {dest.mustSee.map((item) => (
                  ...
                  >
                    <Star size={14} className="text-sand-500 fill-sand-400 mt-0.5 shrink-0" />
            ...
            <div className="bg-sand-100 border border-sand-200 rounded-2xl p-6 flex gap-4">
              <Lightbulb size={20} className="text-sand-600 mt-0.5 shrink-0" />
              <div>
          ...
          <aside className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className={`inline-block mt-1 text-xs font-semibold px-3 py-0.5 rounded-full ${budgetColor[dest.budget]}`}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {dest.tags.map((tag) => (
                      <span key={tag} className="text-xs px-2.5 py-0.5 bg-sand-100 text-ink-600 rounded-full font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
            ...
            {/* Client-side wishlist/visited buttons */}
            <DetailActions id={dest.id} />

            {/* Emoji card */}
            <div
              className="rounded-2xl p-6 flex flex-col items-center gap-2 text-center border"
              style={{ backgroundColor: `${dest.color}12`, borderColor: `${dest.color}30` }}
            >
